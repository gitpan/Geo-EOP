...
Returns the related GML object.  Up to release 1.2.1, this is the
current object.  Later, it will be an extern object, from L<Geo::GML|Geo::GML>.
...
This module is part of Geo-EOP distribution version 0.11,
